...
@pytest.fixture
def player(random_browser_game: Game):
    random_browser_game.start(debug=True)
    player = random_browser_game.players[0]
    player.send = MethodType(lambda self, message: None, player)
    return player
