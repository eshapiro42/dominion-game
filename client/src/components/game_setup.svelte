<script>
    ...
    var allowSimultaneousReactions = {
        ...
        description: [
            ...
            "<b>Supported cards</b>: Bandit, Bishop, Bureaucrat, Duchess, Fool's Gold, Fortune Teller, Goons, Margrave, Masquerade, Militia, Minion, Rabble, Tournament, Vault.",
            "<b>Unsupported cards</b>: Followers, Mountebank, Noble Brigand, Jester, Oracle, Replace, Spy, Swindler, Thief, Torturer, Witch, Young Witch.",
        ],
    };
